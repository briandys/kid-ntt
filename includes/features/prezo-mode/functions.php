...
function ntt_kid_f5e_prezo_mode_styles_scripts() {
    ...
    if ( ntt_kid_f5e_prezo_mode() ) {
        ...
        wp_enqueue_style( $GLOBALS['ntt_kid_f5e_prezo_mode_enqueue_slug']. '-style', get_stylesheet_directory_uri(). '/includes/features/'. $GLOBALS['ntt_kid_f5e_prezo_mode_slug']. '/style.min.css', array( 'ntt-style' ), wp_get_theme()->get( 'Version' ) );
