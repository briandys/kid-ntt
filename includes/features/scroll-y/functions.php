...
function ntt_kid_f5e_scroll_y_styles_scripts() {
    ...
    if ( ntt_kid_f5e_scroll_y() ) {
        ...
        wp_enqueue_style( $GLOBALS['ntt_kid_f5e_scroll_y_enqueue_slug']. '-style', get_stylesheet_directory_uri(). '/includes/features/'. $GLOBALS['ntt_kid_f5e_scroll_y_slug']. '/style.min.css', array( 'ntt-style' ), wp_get_theme()->get( 'Version' ) );
