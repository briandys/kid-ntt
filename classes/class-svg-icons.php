...
class NTT_SVG_Icons {
    ...
    public static $ui_icons = array(
        ...
        'chevron-left'      => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="M74 92.9a7.4 7.4 0 000-10.3L41.4 50 74 17.4A7.3 7.3 0 1063.7 7.1L26 44.9a7.1 7.1 0 00-2.1 5.1c-.1 1.9.7 3.7 2.1 5.1l37.8 37.8a7.2 7.2 0 0010.2 0z"/></svg>',
        ...
        'chevron-up-down'   => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="M24 35a4.4 4.4 0 006.2 0l19.6-19.5 19.6 19.6a4.4 4.4 0 006.2-6.2L52.9 6.3a4.3 4.3 0 00-3-1.3 4 4 0 00-3.1 1.3L24 28.9a4.4 4.4 0 000 6.2zM76 65a4.4 4.4 0 00-6.3 0L50.3 84.4 30.6 64.9a4.4 4.4 0 00-6.2 6.2l22.7 22.6a4.3 4.3 0 003 1.3 4 4 0 003.1-1.3L76 71.1a4.4 4.4 0 000-6.2z"/></svg>',

        'loading-indicator' => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><path d="M27.4 6.2A18.7 18.7 0 1023 43.3l.5-4a14.6 14.6 0 013.4-29l.5-4z"><animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 25 25" to="360 25 25" dur="0.6s" repeatCount="indefinite"/></path></svg>',
    );
}